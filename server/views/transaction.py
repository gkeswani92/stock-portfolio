...
from server.data_access.equity_order import add_equity_order
from server.data_access.equity_order import get_equity_orders_by_user_id
...
def add_transaction_by_user(user_id: int):
    ...
    add_equity_order(user_id, ticker, order_type, quantity, price)
